<template>
  <el-form label-width="100px">
    ...
    <el-form-item label="SKU描述">
      <el-input type="textarea" placeholder="SKU描述" v-model="skuParams.skuDesc" />
    </el-form-item>
...
// 当前子组件的方法对外暴露
const initSkuDta = async (c1Id: number | string, c2Id: number | string, spu: any) => {
  //  收集数据
